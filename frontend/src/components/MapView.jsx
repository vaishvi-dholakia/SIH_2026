...
function MapViewInner({ 
  ...
  const [tileSource, setTileSource] = useState('osm'); // 'osm' | 'esri' | 'dark'
  ...
  const getTileUrl = () => {
    switch (tileSource) {
      ...
      case 'dark':
        return "https://basemaps.cartocdn.com/rastertiles/dark_all/{z}/{y}/{x}{r}.png";
      case 'osm':
      default:
    ...
    <div className="space-y-3 font-sans">
      ...
      <div className="w-full h-[620px] rounded-xl overflow-hidden border border-[#262F40] bg-[#0B0E14] shadow-2xl relative">
        <MapContainer
          ...
          minZoom={4}
          maxZoom={18}
          maxBounds={[[5.0, 65.0], [38.5, 98.5]]} // Strictly lock map bounds to Indian National Territory
