...
async def simulate_hotspot(
    ...
    Supports 6 simulation types: INDUSTRIAL_INCIDENT, SUPPRESSED_FLARE, FOREST_FIRE,
    AGRICULTURAL_FIRE, MINING_FIRE, URBAN_LANDFILL_FIRE.
    Injects detection into database, calculates spatial distance, runs ML classifier,
    computes 0-100 hazard score, and broadcasts WebSocket notification.
    """
    import random
